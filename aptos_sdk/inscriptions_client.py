...
from .aptos_token_client import AptosTokenClient, Object
...
class InscriptionData:
    ...
    struct_tag: str = f"{get_module_address()}::inscriptions::InscriptionData"
...
class InscriptionMetadata:
    ...
    struct_tag: str = f"{get_module_address()}::inscriptions::InscriptionMetadata"
...
class InscriptionState:
    ...
    struct_tag: str = f"{get_module_address()}::inscriptions::InscriptionState"
...
class InscriptionsClient:
    ...
    async def mint_token(
        ...
        payload = InscriptionsClient.mint_token_payload(
            collection, data, description, name, uri,
        )
        signed_transaction = await self.rest_client.create_bcs_signed_transaction(
            creator, payload
        )
    ...
    async def inscriptions_from_transaction(
        ...
        for event in output["events"]:
            if event["type"] != f"{get_module_address()}::inscriptions::InscriptionData":
                continue
