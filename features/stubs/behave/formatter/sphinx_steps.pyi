...
class StepsModule:
    ...
    def __init__(self, module_name, step_definitions: Incomplete | None = None) -> None: ...
    @property
    def name(self): ...
    @property
    def filename(self): ...
...
class SphinxStepsDocumentGenerator:
    ...
    @staticmethod
    def describe_step_definition(step_definition, step_type: Incomplete | None = None): ...
    ...
    def write_docs(self): ...
    def write_step_module_index(self, step_modules, filename: str = "index.rst") -> None: ...
