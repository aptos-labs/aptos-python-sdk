...
class Background(BasicStatement, Replayable):
    type: str
    steps: Incomplete
    def __init__(self, filename, line, keyword, name, steps: Incomplete | None = None) -> None: ...
    def __iter__(self): ...
    @property
    def duration(self): ...
...
class ScenarioOutlineBuilder:
    ...
    @staticmethod
    def render_template(text, row: Incomplete | None = None, params: Incomplete | None = None): ...
    name: Incomplete
    index: Incomplete
    id: Incomplete
    def make_scenario_name(self, outline_name, example, row, params: Incomplete | None = None): ...
    @classmethod
...
class Tag(six.text_type):
    ...
    @classmethod
    def make_name(cls, text, unescape: bool = False, allowed_chars: Incomplete | None = None): ...
