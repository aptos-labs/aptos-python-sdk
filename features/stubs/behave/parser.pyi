...
def parse_feature(data, language: Incomplete | None = None, filename: Incomplete | None = None): ...
def parse_steps(text, language: Incomplete | None = None, filename: Incomplete | None = None): ...
def parse_tags(text): ...
